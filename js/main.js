...
var chooseTag = function (buf) {
  var housingElement = similarHousingTemplate.cloneNode(true);
  var photo = housingElement.querySelector('img[src]');
  housingElement.style = 'left: ' + buf.location.x + 'px; top: ' + buf.location.y + 'px;';
  photo.src = buf.author.avatar;
  photo.alt = buf.offer.title;
...
var getFragment = function () {
  ...
  for (var i = 0; i < NUMBER_OF_OBJECTS; i++) {
    fragment.appendChild(chooseTag(chooseHousing()));
  }
  return fragment;
};
